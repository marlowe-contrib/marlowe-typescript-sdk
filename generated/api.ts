...
export type LabelledObjectTypeEnum =
  (typeof LabelledObjectTypeEnum)[keyof typeof LabelledObjectTypeEnum];

/**
 * @type LabelledObjectValue
 * @export
 */
export type LabelledObjectValue =
  | ActionObject
  | ContractObject
  | ObservationObject
  | PartyObject
 ...
 * @export
 */
export type MarloweStateAccountsInnerInner =
  | Array<AccountTokenTupleInner>
  | number;
...
export type MarloweVersion =
  (typeof MarloweVersion)[keyof typeof MarloweVersion];
...
export type MetadataAndScriptScriptEnum =
  (typeof MetadataAndScriptScriptEnum)[keyof typeof MetadataAndScriptScriptEnum];
...
export type RolesConfig =
  | string
  | { [key: string]: RoleTokenConfig | undefined };
...
export type TransactionErrorOneOfErrorEnum =
  (typeof TransactionErrorOneOfErrorEnum)[keyof typeof TransactionErrorOneOfErrorEnum];
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    applyInputsToContract: async (
      ...
      const localVarPath = `/contracts/{contractId}/transactions`.replace(
        `{${"contractId"}}`,
     ...
     * @throws {RequiredError}
     */
    createContractSources: async (
      main: string,
      labelledObject?: Array<LabelledObject>,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getContractSourceAdjacency: async (
      contractSourceId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      const localVarPath =
        `/contracts/sources/{contractSourceId}/adjacency`.replace(
          `{${"contractSourceId"}}`,
          encodeURIComponent(String(contractSourceId)),
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getContractSourceById: async (
      ...
      const localVarPath = `/contracts/sources/{contractSourceId}`.replace(
        `{${"contractSourceId"}}`,
        encodeURIComponent(String(contractSourceId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getContractSourceClosure: async (
      contractSourceId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'contractSourceId' is not null or undefined
      ...
      const localVarPath =
        `/contracts/sources/{contractSourceId}/closure`.replace(
          `{${"contractSourceId"}}`,
          encodeURIComponent(String(contractSourceId)),
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getContractTransactionById: async (
      contractId: string,
      transactionId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     */
    getContracts: async (
      roleCurrency?: Array<string>,
      tag?: Array<string>,
      partyAddress?: Array<string>,
    ...
    getNextStepsForContract: async (
      ...
      const localVarPath = `/contracts/{contractId}/next`.replace(
        `{${"contractId"}}`,
        encodeURIComponent(String(contractId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPayoutById: async (
      ...
      const localVarPath = `/payouts/{payoutId}`.replace(
        `{${"payoutId"}}`,
    ...
    getPayouts: async (
      ...
      roleToken?: Array<string>,
      status?: GetPayoutsStatusEnum,
      range?: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getTransactionsForContract: async (
      contractId: string,
      range?: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    getWithdrawalById: async (
      ...
      const localVarPath = `/withdrawals/{withdrawalId}`.replace(
        `{${"withdrawalId"}}`,
     ...
     * @throws {RequiredError}
     */
    submitContractTransaction: async (
      contractId: string,
      transactionId: string,
      textEnvelope?: TextEnvelope,
      options: AxiosRequestConfig = {},
  ...
  return {
    ...
    async applyInputsToContract(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ApplyInputsResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.applyInputsToContract(
          contractId,
          xChangeAddress,
          xAddress,
          xCollateralUTxO,
      ...
      const operationBasePath =
        operationServerMap["DefaultApi.applyInputsToContract"]?.[index]?.url;
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.createContract"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async createContractSources(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PostContractSourceResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createContractSources(
          main,
          labelledObject,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.createContractSources"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getContractById(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetContractResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getContractById(
        contractId,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContractById"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getContractSourceAdjacency(
      contractSourceId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ContractSourceIds>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getContractSourceAdjacency(
          contractSourceId,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContractSourceAdjacency"]?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getContractSourceById(
          contractSourceId,
          expand,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContractSourceById"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getContractSourceClosure(
      contractSourceId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getContractSourceClosure(
          contractSourceId,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContractSourceClosure"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getContractTransactionById(
      contractId: string,
      transactionId: string,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getContractTransactionById(
          contractId,
          transactionId,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContractTransactionById"]?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getContracts(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetContractsResponse>
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getContracts"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getNextStepsForContract(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Next>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getNextStepsForContract(
          contractId,
          validityStart,
          validityEnd,
          party,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getNextStepsForContract"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPayoutById(
        payoutId,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getPayoutById"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getPayouts"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getTransactionsForContract(
      contractId: string,
      range?: string,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTransactionsForContract(
          contractId,
          range,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getTransactionsForContract"]?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getWithdrawalById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Withdrawal>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getWithdrawalById(
          withdrawalId,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getWithdrawalById"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getWithdrawals(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetWithdrawalsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getWithdrawals(
        roleCurrency,
        range,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.getWithdrawals"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.healthcheck"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async submitContract(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.submitContract(
        contractId,
        textEnvelope,
        options,
      );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.submitContract"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.submitContractTransaction(
          contractId,
          transactionId,
          textEnvelope,
          options,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.submitContractTransaction"]?.[index]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.submitWithdrawal(
          withdrawalId,
          textEnvelope,
          options,
        );
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.submitWithdrawal"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async withdrawPayouts(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<WithdrawPayoutsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.withdrawPayouts(
        xChangeAddress,
        xAddress,
        xCollateralUTxO,
        postWithdrawalsRequest,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["DefaultApi.withdrawPayouts"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const DefaultApiFactory = function (
  ...
  return {
     ...
     */
    applyInputsToContract(
      requestParameters: DefaultApiApplyInputsToContractRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<ApplyInputsResponse> {
      return localVarFp
        .applyInputsToContract(
          requestParameters.contractId,
          requestParameters.xChangeAddress,
          requestParameters.xAddress,
          requestParameters.xCollateralUTxO,
          requestParameters.postTransactionsRequest,
          options,
        )
     ...
     */
    createContract(
      requestParameters: DefaultApiCreateContractRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<CreateContractResponse> {
      return localVarFp
        .createContract(
          requestParameters.xChangeAddress,
          requestParameters.xStakeAddress,
          requestParameters.xAddress,
          requestParameters.xCollateralUTxO,
          requestParameters.postContractsRequest,
          options,
        )
        .then((request) => request(axios, basePath));
    },
    ...
    createContractSources(
      requestParameters: DefaultApiCreateContractSourcesRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<PostContractSourceResponse> {
      return localVarFp
        .createContractSources(
          requestParameters.main,
          requestParameters.labelledObject,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    getContractById(
      requestParameters: DefaultApiGetContractByIdRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetContractResponse> {
      return localVarFp
        .getContractById(requestParameters.contractId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get the contract source IDs which are adjacent to a contract source (they appear directly in the contract source).
     ...
     */
    getContractSourceAdjacency(
      requestParameters: DefaultApiGetContractSourceAdjacencyRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<ContractSourceIds> {
      return localVarFp
        .getContractSourceAdjacency(requestParameters.contractSourceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    getContractSourceById(
      requestParameters: DefaultApiGetContractSourceByIdRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<Contract> {
      return localVarFp
        .getContractSourceById(
          requestParameters.contractSourceId,
     ...
     */
    getContractSourceClosure(
      requestParameters: DefaultApiGetContractSourceClosureRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<ContractSourceIds> {
      return localVarFp
        .getContractSourceClosure(requestParameters.contractSourceId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    getContractTransactionById(
      requestParameters: DefaultApiGetContractTransactionByIdRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetTransactionResponse> {
      return localVarFp
        .getContractTransactionById(
     ...
     */
    getContracts(
      requestParameters: DefaultApiGetContractsRequest = {},
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetContractsResponse> {
      return localVarFp
        .getContracts(
          requestParameters.roleCurrency,
          requestParameters.tag,
          requestParameters.partyAddress,
          requestParameters.partyRole,
     ...
     */
    getNextStepsForContract(
      requestParameters: DefaultApiGetNextStepsForContractRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<Next> {
      return localVarFp
        .getNextStepsForContract(
          requestParameters.contractId,
          requestParameters.validityStart,
          requestParameters.validityEnd,
          requestParameters.party,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    getPayoutById(
      requestParameters: DefaultApiGetPayoutByIdRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetPayoutResponse> {
      return localVarFp
        .getPayoutById(requestParameters.payoutId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get payouts to parties from role-based contracts. Results are returned in pages, with paging being specified by request headers.
     ...
     */
    getPayouts(
      requestParameters: DefaultApiGetPayoutsRequest = {},
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetPayoutsResponse> {
      return localVarFp
        .getPayouts(
          requestParameters.contractId,
          requestParameters.roleToken,
    ...
    getTransactionsForContract(
      requestParameters: DefaultApiGetTransactionsForContractRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetTransactionsResponse> {
      return localVarFp
        .getTransactionsForContract(
     ...
     */
    getWithdrawalById(
      requestParameters: DefaultApiGetWithdrawalByIdRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<Withdrawal> {
      return localVarFp
        .getWithdrawalById(requestParameters.withdrawalId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get published withdrawal transactions. Results are returned in pages, with paging being specified by request headers.
     ...
     */
    getWithdrawals(
      requestParameters: DefaultApiGetWithdrawalsRequest = {},
      options?: AxiosRequestConfig,
    ): AxiosPromise<GetWithdrawalsResponse> {
      return localVarFp
        .getWithdrawals(
     ...
     */
    submitContract(
      requestParameters: DefaultApiSubmitContractRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .submitContract(
          requestParameters.contractId,
          requestParameters.textEnvelope,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    submitContractTransaction(
      requestParameters: DefaultApiSubmitContractTransactionRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .submitContractTransaction(
     ...
     */
    submitWithdrawal(
      requestParameters: DefaultApiSubmitWithdrawalRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .submitWithdrawal(
          requestParameters.withdrawalId,
          requestParameters.textEnvelope,
          options,
        )
        .then((request) => request(axios, basePath));
     ...
     */
    withdrawPayouts(
      requestParameters: DefaultApiWithdrawPayoutsRequest,
      options?: AxiosRequestConfig,
    ): AxiosPromise<WithdrawPayoutsResponse> {
      return localVarFp
        .withdrawPayouts(
          ...
          requestParameters.xAddress,
          requestParameters.xCollateralUTxO,
          requestParameters.postWithdrawalsRequest,
          options,
        )
        .then((request) => request(axios, basePath));
    },
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public getContractSourceAdjacency(
    requestParameters: DefaultApiGetContractSourceAdjacencyRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
   ...
   * @memberof DefaultApi
   */
  public getContractSourceClosure(
    requestParameters: DefaultApiGetContractSourceClosureRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
   ...
   * @memberof DefaultApi
   */
  public getContractTransactionById(
    requestParameters: DefaultApiGetContractTransactionByIdRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
   ...
   * @memberof DefaultApi
   */
  public getNextStepsForContract(
    requestParameters: DefaultApiGetNextStepsForContractRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
   ...
   * @memberof DefaultApi
   */
  public getTransactionsForContract(
    requestParameters: DefaultApiGetTransactionsForContractRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
   ...
   * @memberof DefaultApi
   */
  public submitContractTransaction(
    requestParameters: DefaultApiSubmitContractTransactionRequest,
    options?: AxiosRequestConfig,
  ) {
    return DefaultApiFp(this.configuration)
...
export type GetPayoutsStatusEnum =
  (typeof GetPayoutsStatusEnum)[keyof typeof GetPayoutsStatusEnum];
